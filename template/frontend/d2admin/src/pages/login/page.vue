    ...
    <div class="page-login--layer">
      <div class="page-login--content" flex="dir:top main:justify cross:center box:justify">
            ...
            <el-card shadow="never">
              <el-form ref="loginForm" label-position="top" :rules="rules" :model="formLogin" size="default">
                <el-form-item prop="username">
                  <el-input type="text" v-model="formLogin.username" placeholder="用户名/手机号">
                ...
                <el-form-item prop="code">
                  <el-input type="text" v-model="formLogin.code" placeholder="- - - -" >
                    ...
                    <template slot="append">
                      <img @click="handleImgCode" class="login-code" :src="imgCode">
                    </template>
                  </el-input>
                </el-form-item>
        ...
        <div class="page-login--content-footer" >
          <p v-if="false" class="page-login--content-footer-options">
            <a href="#">帮助</a>
            <a href="#">隐私</a>
            <a href="#">条款</a>
          </p>
          <p class="page-login--content-footer-copyright">
            Copyright <d2-icon name="copyright"/>重庆臻联盛创科技发展有限公司
          </p>
        </div>
      </div>
    </div>
