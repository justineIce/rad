...
type Error struct {
	Message, Key, Name, Field, Tmpl, Alias, ZhName string
	Value                                          interface{}
...
func (v *Validation) Required(obj interface{}, key string, alias string) *Result {
	return v.apply(Required{key}, obj, alias)
}

// Min Test that the obj is greater than min if obj's type is int
func (v *Validation) Min(obj interface{}, min int, key string, alias string) *Result {
	return v.apply(Min{min, key}, obj, alias)
}

// Max Test that the obj is less than max if obj's type is int
func (v *Validation) Max(obj interface{}, max int, key string, alias string) *Result {
	return v.apply(Max{max, key}, obj, alias)
}

// Range Test that the obj is between mni and max if obj's type is int
func (v *Validation) Range(obj interface{}, min, max int, key string, alias string) *Result {
	return v.apply(Range{Min{Min: min}, Max{Max: max}, key}, obj, alias)
}

// MinSize Test that the obj is longer than min size if type is string or slice
func (v *Validation) MinSize(obj interface{}, min int, key string, alias string) *Result {
	return v.apply(MinSize{min, key}, obj, alias)
}

// MaxSize Test that the obj is shorter than max size if type is string or slice
func (v *Validation) MaxSize(obj interface{}, max int, key string, alias string) *Result {
	return v.apply(MaxSize{max, key}, obj, alias)
}

// Length Test that the obj is same length to n if type is string or slice
func (v *Validation) Length(obj interface{}, n int, key string, alias string) *Result {
	return v.apply(Length{n, key}, obj, alias)
}

// Alpha Test that the obj is [a-zA-Z] if type is string
func (v *Validation) Alpha(obj interface{}, key string, alias string) *Result {
	return v.apply(Alpha{key}, obj, alias)
}

// Numeric Test that the obj is [0-9] if type is string
func (v *Validation) Numeric(obj interface{}, key string, alias string) *Result {
	return v.apply(Numeric{key}, obj, alias)
}

// AlphaNumeric Test that the obj is [0-9a-zA-Z] if type is string
func (v *Validation) AlphaNumeric(obj interface{}, key string, alias string) *Result {
	return v.apply(AlphaNumeric{key}, obj, alias)
}

// Match Test that the obj matches regexp if type is string
func (v *Validation) Match(obj interface{}, regex *regexp.Regexp, key string, alias string) *Result {
	return v.apply(Match{regex, key}, obj, alias)
}

// NoMatch Test that the obj doesn't match regexp if type is string
func (v *Validation) NoMatch(obj interface{}, regex *regexp.Regexp, key string, alias string) *Result {
	return v.apply(NoMatch{Match{Regexp: regex}, key}, obj, alias)
}

// AlphaDash Test that the obj is [0-9a-zA-Z_-] if type is string
func (v *Validation) AlphaDash(obj interface{}, key string, alias string) *Result {
	return v.apply(AlphaDash{NoMatch{Match: Match{Regexp: alphaDashPattern}}, key}, obj, alias)
}

// Email Test that the obj is email address if type is string
func (v *Validation) Email(obj interface{}, key string, alias string) *Result {
	return v.apply(Email{Match{Regexp: emailPattern}, key}, obj, alias)
}

// IP Test that the obj is IP address if type is string
func (v *Validation) IP(obj interface{}, key string, alias string) *Result {
	return v.apply(IP{Match{Regexp: ipPattern}, key}, obj, alias)
}

// Base64 Test that the obj is base64 encoded if type is string
func (v *Validation) Base64(obj interface{}, key string, alias string) *Result {
	return v.apply(Base64{Match{Regexp: base64Pattern}, key}, obj, alias)
}

// Mobile Test that the obj is chinese mobile number if type is string
func (v *Validation) Mobile(obj interface{}, key string, alias string) *Result {
	return v.apply(Mobile{Match{Regexp: mobilePattern}, key}, obj, alias)
}

// Tel Test that the obj is chinese telephone number if type is string
func (v *Validation) Tel(obj interface{}, key string, alias string) *Result {
	return v.apply(Tel{Match{Regexp: telPattern}, key}, obj, alias)
}

// Phone Test that the obj is chinese mobile or telephone number if type is string
func (v *Validation) Phone(obj interface{}, key string, alias string) *Result {
	return v.apply(Phone{Mobile{Match: Match{Regexp: mobilePattern}},
		Tel{Match: Match{Regexp: telPattern}}, key}, obj, alias)
}

// ZipCode Test that the obj is chinese zip code if type is string
func (v *Validation) ZipCode(obj interface{}, key string, alias string) *Result {
	return v.apply(ZipCode{Match{Regexp: zipCodePattern}, key}, obj, alias)
}

func (v *Validation) apply(chk Validator, obj interface{}, alias string) *Result {
	if nil == obj {
...
func (v *Validation) Valid(obj interface{}) (b bool, err error) {
	...
	for i := 0; i < objT.NumField(); i++ {
		...
		var alias string
		sf := objT.Field(i)
		alias, err = getValidAliasFuncs(sf)
		if vfs, err = getValidFuncs(sf, alias); err != nil {
			return
		}
