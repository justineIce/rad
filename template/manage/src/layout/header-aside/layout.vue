  ...
  <div
    ...
    <div class="d2-layout-header-aside-content" flex="dir:top">
      ...
      <div
        ...
        flex="main:justify" >
        <!--原有的-->
        <div class="logo-group" v-if="false"  :style="{width: asideCollapse ? asideWidthCollapse : asideWidth}" flex-box="0">
      ...
      <div class="d2-theme-container" flex-box="1" flex>
        ...
        <div
          ...
          :class="{'aside-collapse':asideCollapse}"
          :style="{
        ...
        <div class="d2-theme-container-main" flex-box="1" flex >
          ...
          <transition name="fade-scale">
            <div v-show="!searchActive" class="d2-theme-container-main-layer" flex="dir:top">
              <!-- tab -->
              <div v-if="false"  class="d2-theme-container-main-header" flex-box="0">
                <d2-tabs/>
              </div>
              <!-- 页面 -->
